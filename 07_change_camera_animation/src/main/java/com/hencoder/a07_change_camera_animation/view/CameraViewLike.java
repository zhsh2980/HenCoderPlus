...
public class CameraViewLike extends View {
    Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    Camera camera = new Camera();

    public CameraViewLike(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.rotate(-20);
        canvas.clipRect(-600, -600, getWidth(), 0);
        canvas.rotate(20);
        canvas.translate(-(100 + 600 / 2), -(100 + 600 / 2));
        ...
        canvas.clipRect(-600, 0, getWidth(), getHeight());
        canvas.rotate(20);
        canvas.translate(-(100 + 600 / 2), -(100 + 600 / 2));
        canvas.drawBitmap(Utils.getAvatar(getResources(), 600), 100, 100, paint);
        canvas.restore();
